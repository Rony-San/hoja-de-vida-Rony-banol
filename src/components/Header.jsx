...
const Header = () => (
  <header className='bg-Negro-plantilla flex items-center h-1/2 md:hidden text-white'>
    <div className='bg-Negro-plantilla h-4/5 flex flex-col items-center justify-self-center p-3 pt-5 w-screen '>
      <div className='flex items-center mx-20  '>
        ...
        <div className=' w-80 flex flex-col ml-2'>
          ...
          <p className=' mt-2 '>Estudiante ingeniería de sistemas</p>
        </div>
      </div>

      <p className=' mx-auto  w-11/12 mt-2 text-xs '>
